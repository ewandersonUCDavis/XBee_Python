#This script adds two new features to tes13.py. 1) It It adds logic to check if any faults have been detected and relay the anyFault attribute to thingsboard.
