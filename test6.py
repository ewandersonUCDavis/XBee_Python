#This script does the same thing as test5.py, but it connects to our own instance of thingsboard, not the test version provided by thingsboard ( "demo.thingsboard.io" )
